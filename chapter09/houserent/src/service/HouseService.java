...
public class HouseService {
    ...
    private static House[] houses; //保存House对象
    private static int houseNums = 1; //记录当前有多少个房屋信息
    ...
    public static House findById(int findId) {
    ...
    //del方法，删除一个房屋信息
    public static boolean del(int delId) {
